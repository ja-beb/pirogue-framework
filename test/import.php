<?php 
    ...
    require_once(implode(DIRECTORY_SEPARATOR, [_PIROGUE_TESTING_LIB_PATH, 'pirogue', 'import.php']));
    ...
    pirogue_test_execute('pirogue_import_load - valid file', fn() => pirogue_import_load('pirogue/cdn'));