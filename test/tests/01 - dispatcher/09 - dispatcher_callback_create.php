...
/**
 * Testing pirogue\dispatcher_callback_create()
 * php version 8.0.0
 *
...
pirogue_test_execute('pirogue\dispatcher_callback_create()', fn () => dispatcher_callback_create(dispatcher_url_current()) == urlencode(dispatcher_url_current()) ? '' : 'invalid return value');
_dispatcher_dispose();
