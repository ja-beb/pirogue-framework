...
function _pirogue_test_database_collection_query(?mysqli $database_connection)
{
    ...
    pirogue_test_execute(
        'pirogue_database_collection_get: valid label',
        fn() => _pirogue_test_database_collection_query(pirogue_database_collection_get('website'))
    );

    // test pirogue_database_collection_get: default label
    pirogue_test_execute(
        'pirogue_database_collection_get: default label',
        fn() => _pirogue_test_database_collection_query(pirogue_database_collection_get())
    );
